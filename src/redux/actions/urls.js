...
export const GET_NEW_CHALLENGE = ROOT.concat('api/institute/');
export const GET_ANSWERS = ROOT.concat('api/institute/answers/');
...
export const MAP_WEBSOCKET = '/user/queue/map';
